...
const unknownResource = (key) => createError(404, `Unknown resource: ${key}`);

const concurrentWrite = () => createError(409, 'Concurrent write detected');

const uploadLengthAlreadySet = () => createError(409, 'Upload length is already set');
